...
class EightBitDigit extends Component {
  constructor(pos) {
    ...
    this.input1 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (1 / 9), eight_bit_digit_height / 2),
    ...
    this.input2 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (2 / 9), eight_bit_digit_height / 2),
      createVector(0, -(component_height * 0.75)),
      "input2_state"
    );
    this.input3_state = false;
    this.input3 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (3 / 9), eight_bit_digit_height / 2),
      createVector(0, -(component_height * 0.75)),
      "input3_state"
    );
    this.input4_state = false;
    this.input4 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (4 / 9), eight_bit_digit_height / 2),
      createVector(0, -(component_height * 0.75)),
      "input4_state"
    );
    this.input5_state = false;
    this.input5 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (5 / 9), eight_bit_digit_height / 2),
      createVector(0, -(component_height * 0.75)),
      "input5_state"
    );
    this.input6_state = false;
    this.input6 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (6 / 9), eight_bit_digit_height / 2),
      createVector(0, -(component_height * 0.75)),
      "input6_state"
    );
    this.input7_state = false;
    this.input7 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (7 / 9), eight_bit_digit_height / 2),
      createVector(0, -(component_height * 0.75)),
      "input7_state"
    );
    this.input8_state = false;
    this.input8 = new ConnectionInPoint(
      this,
      createVector(eight_bit_digit_width * (8 / 9), eight_bit_digit_height / 2),
      createVector(0, -(component_height * 0.75)),
      "input8_state"
    );
    this.connect_points = [
  ...
  draw(graphics, outline) {
    ...
    graphics.rect(
      eight_bit_digit_x,
      eight_bit_digit_y,
      eight_bit_digit_width,
      eight_bit_digit_height
    );

    graphics.stroke(eight_bit_digit_stroke);
    graphics.fill(
      this.display_digit === "00"
        ? eight_bit_digit_stroke
        : eight_bit_digit_powered_fill
    );
    graphics.textAlign(CENTER, CENTER);
    graphics.textSize(
      get_text_size(
        this.display_digit,
        eight_bit_digit_width * 0.75,
        eight_bit_digit_height * 0.75
      )
    );
    graphics.text(
      this.display_digit,
      eight_bit_center.x,
      eight_bit_center.y + eight_bit_digit_height * 0.05
    );
