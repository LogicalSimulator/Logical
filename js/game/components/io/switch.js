...
class Switch extends Component {
  constructor(pos) {
    ...
    this.output1 = new ConnectionOutPoint(
      this,
      createVector(component_width / 2, component_height / 2),
  ...
  draw(graphics, outline) {
    ...
    if (this.powered) {
      graphics.rect(
        center_switch_x - switch_part_diff,
        center_switch_y - switch_part_diff,
        center_switch_width + switch_part_diff * 2,
        center_half_height + switch_part_diff
      );
    } else {
      graphics.rect(
        center_switch_x - switch_part_diff,
        center_switch_y + center_half_height,
        center_switch_width + switch_part_diff * 2,
        center_half_height + switch_part_diff
      );
    }
